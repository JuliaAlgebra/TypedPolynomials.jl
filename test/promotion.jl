@testset "promotion" begin
    ...
    @test typeof(@inferred promote(1, Polynomial(2y))) == NTuple{2, Polynomial{Term{Int, Monomial{(y,), 1}}}}
    @test typeof(@inferred promote(1, Polynomial([2y]))) == NTuple{2, Polynomial{Term{Int, Monomial{(y,), 1}}}}
    ...
    @test typeof(@inferred promote(x, Polynomial(2y))) == NTuple{2, Polynomial{Term{Int, Monomial{(x, y), 2}}}}
    @test typeof(@inferred promote(x, Polynomial([2y]))) == NTuple{2, Polynomial{Term{Int, Monomial{(x, y), 2}}}}
    ...
    @test typeof(@inferred promote(x^2, Polynomial(2y))) == NTuple{2, Polynomial{Term{Int, Monomial{(x, y), 2}}}}
    @test typeof(@inferred promote(x^2, Polynomial([2y]))) == NTuple{2, Polynomial{Term{Int, Monomial{(x, y), 2}}}}
    ...
    @test typeof(@inferred promote(2x, Polynomial(2y))) == NTuple{2, Polynomial{Term{Int, Monomial{(x, y), 2}}}}
    @test typeof(@inferred promote(2x, Polynomial([2y]))) == NTuple{2, Polynomial{Term{Int, Monomial{(x, y), 2}}}}

    @test typeof(@inferred promote(Polynomial(2x), 1)) == NTuple{2, Polynomial{Term{Int, Monomial{(x,), 1}}}}
    @test typeof(@inferred promote(Polynomial(2x), y)) == NTuple{2, Polynomial{Term{Int, Monomial{(x, y), 2}}}}
    @test typeof(@inferred promote(Polynomial(2x), y^2)) == NTuple{2, Polynomial{Term{Int, Monomial{(x, y), 2}}}}
    @test typeof(@inferred promote(Polynomial(2x), 2y)) == NTuple{2, Polynomial{Term{Int, Monomial{(x, y), 2}}}}
    @test typeof(@inferred promote(Polynomial(2x), Polynomial(2y))) == NTuple{2, Polynomial{Term{Int, Monomial{(x, y), 2}}}}
    @test typeof(@inferred promote(Polynomial(2x), Polynomial([2y]))) == NTuple{2, Polynomial{Term{Int, Monomial{(x, y), 2}}}}
